...
<div tabindex="0" aria-label="Main content" id="wpbody-content">
	...
	<h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
		...
		<a class="nav-tab nav-tab-active" href="<?php echo site_url();?>/wp-admin/admin.php?page=mass_cat_assign"><?php _e('Mass Category Assign','woocommerce-jet-integration');?></a>
